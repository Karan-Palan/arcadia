...
const LandingPage = () => {
  ...
  return (
    ...
    <div className="min-h-screen bg-black text-white overflow-hidden relative">
      {/* 16-bit Styled Star Field Animation */}
      {/* <div className="absolute inset-0 pointer-events-none animate-pulse">
        {[...Array(100)].map((_, i) => (
          <div
            key={i}
            className={`absolute w-1 h-1 bg-gradient-to-r from-purple-500 to-pink-500 rounded-full delay-${Math.floor(Math.random() * 5)}s`}
            style={{
        ...
        <section className="bg-gradient-to-r from-purple-900/20 to-pink-900/20 border border-purple-900/30 rounded-2xl p-8 shadow-2xl">
          <div className="flex flex-col md:flex-row gap-8">
            ...
            <div className="flex-grow space-y-4">
              ...
              <div className="flex space-x-4 flex-wrap justify-center md:justify-start">
                <select className="w-full md:w-75 bg-purple-950/30 border border-purple-900/30 rounded-lg px-3 py-2 text-white mb-4 md:mb-0">
          ...
          {generatedImage && (
            <div className="mt-8 flex justify-center space-x-4 flex-wrap">
              <button className="bg-gradient-to-r from-purple-500 to-pink-500 px-6 py-3 rounded-lg hover:opacity-80 mb-4 md:mb-0">
                Mint NFT
              </button>
              <button className="border border-pink-500 text-pink-400 px-6 py-3 rounded-lg hover:bg-pink-500/10 mb-4 md:mb-0">
